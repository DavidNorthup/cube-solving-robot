...
#define MOVE_L MOTOR_2 + DIRECTION_COUNTERCLOCKWISE + ONE_QUARTER_TURN, LR_IDENTIFIER
#define MOVE_L_PRIME MOTOR_2 + DIRECTION_CLOCKWISE + ONE_QUARTER_TURN, LR_IDENTIFIER
